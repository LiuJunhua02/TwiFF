...
MODEL_NAME=${MODEL_NAME:-"/path/to/model_name"}
...
declare -a DATA_PATHS=(
    "/path/to/TwiFF-Bench_results/model_response_unscore.jsonl"
)
declare -a OUT_PATHS=(
    "/path/to/TwiFF-Bench_results/model_response_score_gpt.jsonl"
)
...
for i in "${!DATA_PATHS[@]}"; do
    ...
    python eval/gencot/gencot_vqa_eval.py \
